...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<div class="card-body">
                    ...
                    <p class="card-text negrita">Metodo de pago: </p>
                    <p class="card-text">' . $row["Metodo_Pago"] . '</p>
                    ...
                    <p class="card-text negrita">Usuario: </p>
                    <p class="card-text">' . $row["Usuario"] . '</p>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="update_factura.php">
                                        ...
                                        <div class="mb-3">
                                            <label for="metodo_pago" class="form-label">Método Pago</label><br>
                                            <input type="text" class="form-control" name="metodo_pago" value="' . $row["Metodo_Pago"] . '">
                                        </div>
                                        <div class="mb-3">
