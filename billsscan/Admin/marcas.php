...
<div class="cabeza">
    <div class="centrado">
        <div class="ruta">
            <span class="titulo_ruta"><a href="./categorias.php">Categorías</a>>Compra de Productos</span>
        ...
        <div class="total_gastado">
            ...
            $sql1 = "SELECT SUM(total_compra) AS total_gastado FROM cambio";
            $result1 = $con->query($sql1);
            $row1 = $result1->fetch_assoc();
            $total_gastado = $row1['total_gastado'];

            // Consulta para el total de facturas
            $sql2 = "SELECT COUNT(*) AS total_facturas FROM facturas";
            ...
            echo '
            <span class="brand-name">Gasto total de empleados:<br> $'. $total_formateado . ' MXN</span>
            <span class="brand-name">Total de Facturas: ' . $total_facturas_formateado .'</span>
            ';
    ...
    <div class="contenedor-scroll">
        <div class="brand">
            <div class="brand-list">
                ...
                // Consulta modificada para obtener totales por iniciales
                $sql = "SELECT
                        ...
                        WHERE denominacion_social LIKE '%$search%'
                        GROUP BY
